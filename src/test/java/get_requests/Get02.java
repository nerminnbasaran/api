...
public class Get02 {
    ...
    public void get02(){
        ...
        //Set the expected data -- we pass this step because we will not set any data
        ...
        //Response body does not contain "TechProEd"
        assertFalse(response.asString().contains("TechPro"));//assertFalse() passes if the value between parenthesis is "false"
